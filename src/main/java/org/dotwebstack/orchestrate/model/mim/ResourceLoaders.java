...
public class ResourceLoaders {
  ...
  private static final Path LOCAL_RESOURCE_PATH = Paths.get("/")
      .toAbsolutePath();
  ...
  public static Optional<Path> getResource(@NonNull String resourceLocation) {
    ...
    try {
      ...
      throw new ResourceLoadersException(String.format("Could not get URI for %s", resourceLocation),
          uriSyntaxException);
    }

    var systemResourcePath =
        Path.of(classPathUri);
